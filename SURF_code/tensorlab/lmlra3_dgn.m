function [U,S,output] = lmlra3_dgn(T,U0,varargin)
...
%      options.Normalize = true - Normalize result if true.
...
% Check the tensor T.
if ~isnumeric(T)
    error('lmlra3_dgn:T', 'lmlra_hooi currently only accepts dense tensors.');
end
N = ndims(T);
